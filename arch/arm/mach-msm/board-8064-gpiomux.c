...
// 2013.02.19 code by effectivesky for 12135 patch
#if 0
...
static struct msm_gpiomux_config apq8064_hdmi_configs[] __initdata = {
	...
	{				// CONFIG_INPUT_IR_SENSOR, LEVEL_SHIFT_EN uses gpio_33 for EF52W PT10
...
#endif	// CONFIG_KS8851 || CONFIG_KS8851_MODULE
...
struct msm_gpiomux_config apq8064_touch_config[] = {
	...
	{	/* TS RESET */
#if CONFIG_BOARD_VER >= CONFIG_PT10 && !(defined(CONFIG_MACH_APQ8064_EF50L) || defined(CONFIG_MACH_APQ8064_EF51L) || defined(CONFIG_MACH_APQ8064_EF52S) || defined(CONFIG_MACH_APQ8064_EF52K) || defined(CONFIG_MACH_APQ8064_EF52L) || defined(CONFIG_MACH_APQ8064_EF52W))
		.gpio = 43,
