...
enum {
	MSM_RPM_ID_NOTIFICATION_CONFIGURED_0 = 0,		//0
	MSM_RPM_ID_NOTIFICATION_CONFIGURED_7 =			//7
		MSM_RPM_ID_NOTIFICATION_CONFIGURED_0 + 7,

	MSM_RPM_ID_NOTIFICATION_REGISTERED_0,			//8
	MSM_RPM_ID_NOTIFICATION_REGISTERED_7 =			//15
		MSM_RPM_ID_NOTIFICATION_REGISTERED_0 + 7,

	MSM_RPM_ID_INVALIDATE_0,						//16
	MSM_RPM_ID_INVALIDATE_7 =						//23
		MSM_RPM_ID_INVALIDATE_0 + 7,

	MSM_RPM_ID_TRIGGER_TIMED_TO,					//24
	MSM_RPM_ID_TRIGGER_TIMED_0,						//25
	MSM_RPM_ID_TRIGGER_TIMED_SCLK_COUNT,			//26

	MSM_RPM_ID_RPM_CTL,								//27

	/* TRIGGER_CLEAR/SET deprecated in these 24 RESERVED bytes */
	MSM_RPM_ID_RESERVED_0,							//28
	MSM_RPM_ID_RESERVED_5 =						//33
		MSM_RPM_ID_RESERVED_0 + 5,

	MSM_RPM_ID_CXO_CLK,							//34
	MSM_RPM_ID_PXO_CLK,							//35
	MSM_RPM_ID_APPS_FABRIC_CLK,					//36
	MSM_RPM_ID_SYSTEM_FABRIC_CLK,				//37
	MSM_RPM_ID_MM_FABRIC_CLK,					//38
	MSM_RPM_ID_DAYTONA_FABRIC_CLK,				//39
	MSM_RPM_ID_SFPB_CLK,						//40
	MSM_RPM_ID_CFPB_CLK,						//41
	MSM_RPM_ID_MMFPB_CLK,						//42
	MSM_RPM_ID_EBI1_CLK,						//43

	MSM_RPM_ID_APPS_FABRIC_CFG_HALT_0,			//44
	MSM_RPM_ID_APPS_FABRIC_HALT_0 =				//44
		MSM_RPM_ID_APPS_FABRIC_CFG_HALT_0,
	MSM_RPM_ID_APPS_FABRIC_CFG_HALT_1,			//45
	MSM_RPM_ID_APPS_FABRIC_CFG_CLKMOD_0,		//46
	MSM_RPM_ID_APPS_FABRIC_CLOCK_MODE_0 =		//46
		MSM_RPM_ID_APPS_FABRIC_CFG_CLKMOD_0,
	MSM_RPM_ID_APPS_FABRIC_CFG_CLKMOD_1,		//47
	MSM_RPM_ID_APPS_FABRIC_CFG_CLKMOD_2,		//48
	MSM_RPM_ID_APPS_FABRIC_CFG_IOCTL,			//49
	MSM_RPM_ID_APPS_FABRIC_ARB_0,				//50
	MSM_RPM_ID_APPS_FABRIC_ARB_11 =				//61
		MSM_RPM_ID_APPS_FABRIC_ARB_0 + 11,

	MSM_RPM_ID_SYS_FABRIC_CFG_HALT_0,			//62
	MSM_RPM_ID_SYSTEM_FABRIC_HALT_0 =			//62
		MSM_RPM_ID_SYS_FABRIC_CFG_HALT_0,
	MSM_RPM_ID_SYS_FABRIC_CFG_HALT_1,			//63
	MSM_RPM_ID_SYS_FABRIC_CFG_CLKMOD_0,			//64
	MSM_RPM_ID_SYSTEM_FABRIC_CLOCK_MODE_0 =		//64
		MSM_RPM_ID_SYS_FABRIC_CFG_CLKMOD_0,
	MSM_RPM_ID_SYS_FABRIC_CFG_CLKMOD_1,			//65
	MSM_RPM_ID_SYS_FABRIC_CFG_CLKMOD_2,			//66
	MSM_RPM_ID_SYS_FABRIC_CFG_IOCTL,			//67
	MSM_RPM_ID_SYSTEM_FABRIC_ARB_0,				//68
	MSM_RPM_ID_SYSTEM_FABRIC_ARB_29 =			//97
		MSM_RPM_ID_SYSTEM_FABRIC_ARB_0 + 29,

	MSM_RPM_ID_MMSS_FABRIC_CFG_HALT_0,			//98
	MSM_RPM_ID_MM_FABRIC_HALT_0 =				//98
		MSM_RPM_ID_MMSS_FABRIC_CFG_HALT_0,
	MSM_RPM_ID_MMSS_FABRIC_CFG_HALT_1,			//99
	MSM_RPM_ID_MMSS_FABRIC_CFG_CLKMOD_0,		//100
	MSM_RPM_ID_MM_FABRIC_CLOCK_MODE_0 =			//100
		MSM_RPM_ID_MMSS_FABRIC_CFG_CLKMOD_0,
	MSM_RPM_ID_MMSS_FABRIC_CFG_CLKMOD_1,		//101
	MSM_RPM_ID_MMSS_FABRIC_CFG_CLKMOD_2,		//102
	MSM_RPM_ID_MMSS_FABRIC_CFG_IOCTL,			//103
	MSM_RPM_ID_MM_FABRIC_ARB_0,					//104
	MSM_RPM_ID_MM_FABRIC_ARB_22 =				//126
		MSM_RPM_ID_MM_FABRIC_ARB_0 + 22,

	MSM_RPM_ID_PM8921_S1_0,	//127
