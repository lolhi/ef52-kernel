...
#define SKY_SOC_EMPTY	3580	// 3.58 X 1000
#define SKY_SOC_FULL	97000	// 97 X 1000, vell = 4.3V
#define SKY_DEFAULT_RCOMP	0x5B
#define SKY_TEMP_CO_HOT		0 // 0 X 1000
#define SKY_TEMP_CO_COLD	-4225 // -4.225 X 1000
#else
