...
static int __init mipi_cmd_sony_hd_init(void)
{
	...
	pinfo.lcd.v_back_porch = 0;//4;// 20130110 shkwak, to prevent tearing in upper side
	pinfo.lcd.v_front_porch = 10;
	pinfo.lcd.v_pulse_width = 4;// shkwak 20121123, v_pulse test value for tearing
	...
	pinfo.mipi.frame_rate = 62;  //60; 62 for CTS android.view.cts.DisplayRefreshRateTest failure
	pinfo.mipi.te_sel = 1;
