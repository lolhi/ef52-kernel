...
#ifdef CONFIG_PANTECH_WLAN_802_11_AC_DATA_RATE_DISPLAY  /* 20130419 thkim_wifi add for 802.11ac data rate display, CN 01162209 */
	if (!rate)
		return false;
...
#endif  /* CONFIG_PANTECH_WLAN_802_11_AC_DATA_RATE_DISPLAY */
}
